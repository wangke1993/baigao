...
@Schema()
export class AdManger extends BaseSchema {
...
export type AdMangerDocument = AdManger & Document;

export const AdMangerSchema = SchemaFactory.createForClass(AdManger);