...
<template>
  <div class="error-page_page__6HKvE">
    <div class="error-page_page-images__ouapd">
    ...
    <div class="error-page_page-title__1z5n7">404</div>
    <div class="error-page_page-subtitle__18CS8">您访问的页面不存在</div>
    <div class="error-page_page-extra__1USsY">
      <el-button class="btn" type="primary" @click="returnFun">回到首页</el-button>
    </div>
  </div>
</template>
<script lang="ts">
...
.error-page_page__6HKvE {
  ...
  .error-page_page-images__ouapd {
    width: 250px;
    height: 295px;
    margin: 0 auto;
  }

  .error-page_page-title__1z5n7 {
    width: 100%;
    font-size: 24px;
    line-height: 1.8;
    text-align: center;
  ...
  .error-page_page-subtitle__18CS8 {
    width: 100%;
