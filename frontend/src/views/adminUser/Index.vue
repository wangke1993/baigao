      ...
      <el-table-column label="操作">
        <template #default="scope">
          <el-button-group class="ml-4">
            ...
            <el-button
              v-if="btnShow('user_update_password')"
            ...
            >
            <el-popconfirm
              v-if="btnShow('user_reset_password')"
              confirm-button-text="确定"
              cancel-button-text="取消"
              confirm-button-type="warning"
              :title="`确定要重置用户【${scope.row.userName}】的密码吗？`"
...
import {
  ...
  AdminUserControllerDelete,
  AdminUserControllerGetPage,
