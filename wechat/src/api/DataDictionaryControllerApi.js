...
* @returns 
*/
export function DataDictionaryControllerGetTree(){
	// query:{} 
   return get(`/admin/dic/getTree`, {});
}
/**
...
* @returns 
*/
export function DataDictionaryControllerCreateDicEnum(){
   return post(`/admin/dic/createDicEnum`, {});
}
